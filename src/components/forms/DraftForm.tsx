...
interface DraftFormProps extends FormProps {
...
const DraftForm = ({body,setBody,title,setTitle,type,setType,slug,setSlug, ...formProps}: DraftFormProps)=>{
